...
import br.com.cds.connecta.presenter.components.viewers.amcharts.AmLegend;
...
import br.com.cds.connecta.presenter.components.viewers.amcharts.AmBalloon;
import br.com.cds.connecta.presenter.components.viewers.amcharts.AmGraph;
...
public class JsonConversionTest {
    ...
    private static String json(String json) throws IOException {
        return IOUtils.toString(new FileInputStream("src/test/resources/json/amcharts/"+json+".json"));
    }
...
//REVER         assertThat(chart.getType(), is("xy"));
        ...
        assertThat(chart.getDataProvider().get(0), isA(Object.class));
    }
